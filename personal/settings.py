...
MEDIA_ROOT = root('personal', 'media') + '/'
...
STATIC_ROOT = root('personal', 'static') + '/'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    root('personal', 'templates')
)

BUILD_DIR = root('build')

BAKERY_VIEWS = [
    'website.views.IndexListView',
    'website.views.PublicationsListView',
    'website.views.ContactTemplateView',
    'website.views.AboutTemplateView',
]
